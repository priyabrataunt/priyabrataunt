...
class SoftwareEngineer:
    ...
    def __init__(self):
        self.name = "Priyabrata Behera"
        self.role = "Tech Enthusiast | Passionate Coder | Active Learner"
        self.highlights = [
            "Tech Enthusiast who loves building and learning",
            "Passionate about coding, problem-solving, and real-world projects",
            "Always exploring new tools, frameworks, and technologies",
            "Open to collaboration on impactful projects",
        ]
        self.links = {
            "linkedin": "https://www.linkedin.com/in/beherapriyabrata/",
            "github": "https://github.com/priyabrataunt",
        }
...
- 🌱 Learning consistently (DSA, full-stack, and modern AI tools)  
- 🧠 Exploring AI/ML and automation ideas
